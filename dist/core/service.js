...
export function makeHttpService(config) {
    return new HttpServiceImpl(config);
}
var HttpServiceImpl = /** @class */ (function () {
    function HttpServiceImpl(init) {
    ...
    HttpServiceImpl.prototype.fetch = function (api, options) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.httpClient.request(request)];
                    case 2:
                        data = _a.sent();
